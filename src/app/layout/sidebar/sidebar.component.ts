...
export class SidebarComponent implements OnInit {
    ...
    constructor(public configService: ConfigService, public menu: MenuService, public settings: SettingsService, private authService: AuthService, public injector: Injector) {
        menu.getMenu().subscribe(result => {
            this.menuItems = result.filter(item => {
                return this.authService.hasPrivilege(item.text);
            });
